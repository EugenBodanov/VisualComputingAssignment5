...
namespace flagPlane
{
    const Matrix4D trans = Matrix4D::translation({0.0f, 0.0f, -9.6f});
}
...
struct Plane
{
    ...
    Vector3D basePosition = {0.0, 70.0, 0.0};
...
/**
 * @brief Sets the emission of the lights of the given plane part to be on or off.
 */
